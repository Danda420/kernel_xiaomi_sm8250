...
static int
copy_class_datum_partially_callback(struct hashtab_node *new_node, CONST_IF_6_10 struct hashtab_node *old_node, void *data)
{
...
static int
copy_role_datum_partially_callback(struct hashtab_node *new_node, CONST_IF_6_10 struct hashtab_node *old_node, void *data)
{
	int ret = 0;
	struct policydb *db = data;
